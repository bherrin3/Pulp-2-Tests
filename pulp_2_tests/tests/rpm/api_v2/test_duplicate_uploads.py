...
class DuplicateUploadAndCopyTestCase(unittest.TestCase):
    ...
    def test_upload_copy_manifest(self):
        ...
        self.assertEqual(
            len(search_units(cfg, repos[0], {'type_ids': ['iso']})),
            1,
            search_units(cfg, repos[0], {'type_ids': ['iso']})
        )
        ...
        self.assertEqual(
            len(search_units(cfg, repos[1], {'type_ids': ['iso']})),
            1,
            search_units(cfg, repos[1], {'type_ids': ['iso']})
        )
